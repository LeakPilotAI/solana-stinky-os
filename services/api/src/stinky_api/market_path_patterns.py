...
def discover_market_path_patterns(
    ...
    *,
    ...
    This deliberately discovers repetition without evaluating whether a pattern
    is good, bad, predictive, risky, or tradeable.
    """
