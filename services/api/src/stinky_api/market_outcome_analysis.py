...
def analyze_market_lifecycle(records: list[dict[str, Any]], *, limit: int = 100) -> dict[str, Any]:
    """Return factual path/extreme measurements from already-observed lifecycle records.

    No missing horizon is interpolated, and no measurement is converted into a
    success/failure label, prediction, probability, quality, risk, or trade signal.
    """
