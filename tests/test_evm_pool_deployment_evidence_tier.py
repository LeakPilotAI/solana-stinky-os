...
from stinky_core.evm_pool_deployment_evidence_tier import assess_pool_deployment_evidence_tier
...
def attested(verdict, address=POOL):
    return FactoryAttestedPoolDeploymentEvidence(
        None, "base", FACTORY, address, 123, verdict,
